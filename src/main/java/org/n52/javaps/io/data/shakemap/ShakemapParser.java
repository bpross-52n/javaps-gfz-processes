...
public class ShakemapParser extends AbstractPropertiesInputOutputHandler implements InputHandler {
    ...
    public ShakemapDataBinding parse(TypedProcessInputDescription<?> description, InputStream input, Format format) {

        ShakemapGridDocument shakemapGrid;

        try {
            shakemapGrid = ShakemapGridDocument.Factory.parse(input);
